...
export default function Search(props) {
    ...
    return (
        <>
            <div className="s003 mb-4">
            <form onSubmit={handleSubmit}>
                <div className="inner-form mb-2">
                    <div className="input-field first-wrap">
                        <input onChange={handleInputChange} name="location" id="location" type="text" value={value.location} placeholder="Location?" />
                    </div>
                    <div className="input-field second-wrap">
                        <input onChange={handleInputChange} name="description" id="description" 
                        value={value.description} type="text" placeholder="Job Description?" />
                    </div>
